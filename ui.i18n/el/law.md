...
2. Μη εξουσιοδοτημένη πρόσβαση ή τροποποίηση των εκπομπών ή των δεδομένων σας
3. Δηλώσεις ή ενέργειες που γίνονται από οποιοδήποτε τρίτο μέρος σε αυτήν την υπηρεσία
4. Το τρίτο μέρος δημοσιεύει ή παραδίδει δόλιες πληροφορίες με οποιονδήποτε τρόπο ή παρακινεί τους χρήστες να υποστούν οικονομικές ζημίες
...
Εάν παραβιάσετε τους νόμους που σχετίζονται με τα δικαιώματα πνευματικής ιδιοκτησίας, θα φέρετε τη ζημία που προκλήθηκε σε άλλους (συμπεριλαμβανομένου αυτού του ιστότοπου) από τον εαυτό σας και θα φέρετε την αντίστοιχη νομική ευθύνη.
