...
2. ތިބާގެ ޓްރާންސްމިޝަންތަކަށް ނުވަތަ ޑޭޓާއަށް ހުއްދަ ނެތި އެކްސެސް ނުވަތަ ބަދަލުކުރުން
3. މި ހިދުމަތުގައި ތިންވަނަ ފަރާތަކުން ކުރާ ބަޔާންތައް ނުވަތަ އަމަލުތައް
4. ތިންވަނަ ފަރާތުން އެއްވެސް ގޮތަކުން އޮޅުވާލައިގެން މައުލޫމާތު ޝާއިއުކުރުން ނުވަތަ ފޯރުކޮށްދިނުން، ނުވަތަ ޔޫޒަރުންނަށް އިގްތިސާދީ ގެއްލުންތަކެއް ކުރިމަތިކުރުވުން
...
ނެޓްވޯކް ޚިދުމަތްތަކުގެ ޚާއްޞަކަމަށް ބަލާއިރު (ސަރވަރ ސްޓެބިލިޓީ މައްސަލަތައް، ނުބައި ނެޓްވޯކް ހަމަލާތައް ފަދަ ކަންކަން ހިމެނޭގޮތަށް، ނުވަތަ މި ވެބްސައިޓުގެ ކޮންޓްރޯލުން ބޭރުގައިވާ ޙާލަތްތައް ހިމެނޭގޮތަށް) މި ވެބްސައިޓަށް ބައެއް ނުވަތަ ހުރިހާ ޚިދުމަތްތަކެއް މެދުކަނޑާލުމުގެ ނުވަތަ ނިމުމަކަށް ގެނައުމުގެ ހައްގު ލިބިގެންވާކަމަށް އެއްބަސްވެވަޑައިގަންނަވައެވެ ގެ ޚިދުމަތްތައް ކޮންމެ ވަގުތެއްގައިވެސް.

މި ވެބްސައިޓުން ދޭތެރެ ދޭތެރެއިން ޚިދުމަތް އަޕްގްރޭޑްކޮށް ބެލެހެއްޓޭނެތީ، ޚިދުމަތް މެދުކަނޑާލާއިރު، މި ވެބްސައިޓުން އެއްވެސް ޒިންމާއެއް ނުނަގައެވެ.
...
ފިކުރީ މުދަލުގެ ހައްގުތަކާ ގުޅޭ ގާނޫނުތަކާ ހިލާފުވެއްޖެނަމަ، އެހެން މީހުންނަށް (މި ވެބްސައިޓް ހިމެނޭގޮތަށް) ލިބޭ ގެއްލުން އަމިއްލައަށް އުފުލަން ޖެހޭނެ ކަމަށާއި، އެކަމާ ގުޅޭ ގާނޫނީ ޒިންމާ އުފުލަން ޖެހޭނެ ކަމަށެވެ.
