...
თუ არასრულწლოვანი ხართ, უნდა წაიკითხოთ ეს შეთანხმება თქვენი მეურვის ხელმძღვანელობით და გამოიყენოთ ეს ვებგვერდი მას შემდეგ, რაც მიიღებთ თქვენი მეურვის თანხმობას ამ შეთანხმებაზე. თქვენ და თქვენი მეურვე ხართ პასუხისმგებელი კანონის და ამ ხელშეკრულების დებულებების შესაბამისად.
...
თქვენ ნათლად გესმით და ეთანხმებით, რომ ეს ვებგვერდი არ არის პასუხისმგებელი რაიმე პირდაპირი, ირიბი, შემთხვევითი, წარმოებული ან სადამსჯელო ზიანისთვის, რომელიც გამოწვეულია შემდეგი მიზეზებით, მათ შორის, მაგრამ არ შემოიფარგლება ეკონომიკური, რეპუტაციით, მონაცემთა დაკარგვით ან სხვა არამატერიალური ზარალით:

1. ეს სერვისი მიუწვდომელია
2. თქვენი გადაცემების ან მონაცემების არასანქცირებული წვდომა ან შეცვლა
3. ამ სერვისში ნებისმიერი მესამე მხარის მიერ გაკეთებული განცხადებები ან ქმედებები
4. მესამე მხარე აქვეყნებს ან აწვდის თაღლითურ ინფორმაციას რაიმე ფორმით, ან აიძულებს მომხმარებლებს განიცადონ ეკონომიკური ზარალი.
