...
ایک بار جب آپ اس ویب سائٹ پر اندراج کر لیتے ہیں، تو سمجھا جاتا ہے کہ آپ اس معاہدے کو سمجھ چکے ہیں اور اس سے مکمل طور پر متفق ہیں (اور اس ویب سائٹ پر صارف کے معاہدے میں مستقبل کی اپ ڈیٹس اور ترمیمات)۔
...
اگر آپ نابالغ ہیں، تو آپ کو اپنے سرپرست کی رہنمائی میں اس معاہدے کو پڑھنا چاہیے، اور اس معاہدے کے لیے اپنے سرپرست کی رضامندی حاصل کرنے کے بعد اس ویب سائٹ کا استعمال کریں۔ آپ اور آپ کے سرپرست قانون اور اس معاہدے کی دفعات کے مطابق ذمہ دار ہوں گے۔

اگر آپ نابالغ صارف کے سرپرست ہیں، تو براہ کرم غور سے پڑھیں اور احتیاط سے انتخاب کریں کہ آیا اس معاہدے سے اتفاق کرنا ہے۔

## ڈس کلیمر

آپ واضح طور پر سمجھتے ہیں اور اس بات سے اتفاق کرتے ہیں کہ یہ ویب سائٹ درج ذیل وجوہات کی وجہ سے کسی بھی براہ راست، بالواسطہ، واقعاتی، مشتق یا تعزیری نقصانات کے لیے ذمہ دار نہیں ہوگی، بشمول معاشی، ساکھ، ڈیٹا کے نقصان یا دیگر غیر محسوس نقصانات تک محدود نہیں:

1. یہ سروس دستیاب نہیں ہے۔
2. آپ کی ترسیل یا ڈیٹا تک غیر مجاز رسائی یا اس میں ردوبدل
3. اس سروس میں کسی تیسرے فریق کے ذریعہ کئے گئے بیانات یا اقدامات
4. فریق ثالث کسی بھی طرح سے دھوکہ دہی والی معلومات شائع کرتا ہے یا فراہم کرتا ہے، یا صارفین کو معاشی نقصان اٹھانے پر اکساتا ہے۔
...
ہم صرف ضروری مقصد اور دائرہ کار کے اندر فریق ثالث کو آپ کی ذاتی معلومات فراہم کریں گے، اور فریق ثالث کی حفاظتی صلاحیتوں کا بغور جائزہ لیں گے اور ان کی نگرانی کریں گے، ان سے قانون اور ضوابط، تعاون کے معاہدوں کی پابندی کریں گے اور آپ کی ذاتی معلومات کی حفاظت کے لیے متعلقہ حفاظتی اقدامات کریں گے۔ .