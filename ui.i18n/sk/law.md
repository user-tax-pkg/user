...
2. Neoprávnený prístup alebo zmena vašich prenosov alebo údajov
3. Vyhlásenia alebo akcie vykonané akoukoľvek treťou stranou v tejto službe
4. Tretia strana akýmkoľvek spôsobom zverejňuje alebo dodáva podvodné informácie alebo navádza používateľov k ekonomickým stratám

## Zabezpečenie účtu

Po dokončení procesu registrácie tejto služby a úspešnej registrácii je vašou zodpovednosťou chrániť bezpečnosť svojho účtu.
...
Vzhľadom na špecifickosť sieťových služieb (vrátane, ale nie výlučne, problémov so stabilitou servera, škodlivých sieťových útokov atď., alebo okolností mimo kontroly tejto webovej stránky), súhlasíte s tým, že táto webová lokalita má právo prerušiť alebo ukončiť niektoré alebo všetky služieb kedykoľvek.
...
Táto webová stránka má právo kedykoľvek prerušiť alebo ukončiť službu, ktorú vám poskytuje, a odstrániť váš účet a obsah bez zodpovednosti voči vám alebo akejkoľvek tretej strane.
