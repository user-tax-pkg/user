...
Du förstår tydligt och samtycker till att denna webbplats inte ska hållas ansvarig för några direkta, indirekta, tillfälliga, härledda eller bestraffande skador som orsakas av följande skäl, inklusive men inte begränsat till ekonomiska, rykte, dataförluster eller andra immateriella förluster:

1. Den här tjänsten är inte tillgänglig
2. Obehörig åtkomst till eller ändring av dina överföringar eller data
3. Uttalanden eller åtgärder gjorda av tredje part i denna tjänst
4. Den tredje parten publicerar eller levererar bedräglig information på något sätt, eller förmår användare att lida ekonomiska förluster
...
Om denna webbplats anser att någon av dina handlingar bryter mot eller kan bryta mot några bestämmelser i nationella lagar och förordningar, kan denna webbplats avsluta tjänsten för dig när som helst.
